...
export const NEIGHBORHOOD_SOURCES: Partial<Record<MarketKey, NeighborhoodSource>> = {
  ...
  // Austin and Raleigh intentionally omitted — see
  // project-docs/data-sources-by-msa.md "Neighborhoods — verification
  // notes" for what was checked and why they're not lit up yet.
};
